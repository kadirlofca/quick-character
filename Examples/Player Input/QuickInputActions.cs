...
public partial class @QuickInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""PrimaryAction"",
                    ""type"": ""Button"",
                    ""id"": ""237b7665-d9e7-4a03-871c-c01ff74354ff"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""a39d57a7-3002-40c8-8c8d-d560b14ef49a"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": ""Press(behavior=2)"",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d263a7a4-4f2f-4c8b-aa90-f52f4d730567"",
                ...
                {
                    ""name"": """",
                    ""id"": ""70406904-5fc9-4def-a139-9ad8e1dffae7"",
    ...
    ""controlSchemes"": []
        ...
        m_Simple_PrimaryAction = m_Simple.FindAction("PrimaryAction", throwIfNotFound: true);
        m_Simple_SecondaryAction = m_Simple.FindAction("SecondaryAction", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Simple_PrimaryAction;
    private readonly InputAction m_Simple_SecondaryAction;
    public struct SimpleActions
    {
        ...
        public InputAction @PrimaryAction => m_Wrapper.m_Simple_PrimaryAction;
        public InputAction @SecondaryAction => m_Wrapper.m_Simple_SecondaryAction;
        ...
        public void SetCallbacks(ISimpleActions instance)
        {
            if (m_Wrapper.m_SimpleActionsCallbackInterface != null)
            {
                ...
                @PrimaryAction.started -= m_Wrapper.m_SimpleActionsCallbackInterface.OnPrimaryAction;
                @PrimaryAction.performed -= m_Wrapper.m_SimpleActionsCallbackInterface.OnPrimaryAction;
                @PrimaryAction.canceled -= m_Wrapper.m_SimpleActionsCallbackInterface.OnPrimaryAction;
                @SecondaryAction.started -= m_Wrapper.m_SimpleActionsCallbackInterface.OnSecondaryAction;
                @SecondaryAction.performed -= m_Wrapper.m_SimpleActionsCallbackInterface.OnSecondaryAction;
                @SecondaryAction.canceled -= m_Wrapper.m_SimpleActionsCallbackInterface.OnSecondaryAction;
            }
