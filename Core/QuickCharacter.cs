...
namespace QUICK
{
    ...
    public class QuickCharacter : MonoBehaviour
    {
        ...
        // Constants
        private const float MAX_FLOOR_DIST = 0.06f;
        ...
        public bool isOnFloor { get { return floor.isValid; } }
        ...
        public bool Jump(float force, int maxNumberOfJumps, bool resetVerticalVelocity, float cayoteTime)
        {
        ...
        protected void FindWall(Vector3 checkDirection, float checkLength, float checkHeight, float verticalOffsetFromCenter, out Surface wallSurface)
        {
        ...
        protected void ApplySurfacePull(float force, Surface pullingSurface)
        {
            rb.velocity += -pullingSurface.normal * force;
        }
